...
function provjeraUloge($uloga3, $uloga4, $uloga5) {
    $korisnik = isset($_SESSION["PzaWeb"]) ? $_SESSION["PzaWeb"] : "";
    if ($korisnik == "" || $korisnik->get_status() != 1 ||
            ($korisnik->get_tipKorisnika() != $uloga3 &&
            $korisnik->get_tipKorisnika() != $uloga4 && $korisnik->get_tipKorisnika() != $uloga5)) {
